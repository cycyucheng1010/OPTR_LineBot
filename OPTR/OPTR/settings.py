"""
Django settings for OPTR project.
...
SECRET_KEY = 'django-insecure-34xnbq4p!$nx1cnl+-v+01!2%@9v!h$3^$(hj1r4awcxfku&o6'
...
WSGI_APPLICATION = 'OPTR.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['http://*', 'https://f14d-2400-8902-00-f03c-93ff-fee7-4e7f.jp.ngrok.io/']
